      ...
      <div className="bg-[#1D1F2C] rounded-2xl w-full max-w-md p-8 relative text-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-between mt-8">
            <button type="submit" className="w-5/12 py-3 bg-gray-700 text-white rounded-full hover:bg-gray-600 transition">생성하기</button>
            <button type="button" onClick={handleEnterClick} className="w-5/12 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-500 transition">입장하기</button>
          </div>
        </form>
      </div>
    </div>
