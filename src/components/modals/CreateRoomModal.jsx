  ...
  const handleSubmit = (e) => {
    e.preventDefault();
      onCreate({
        ...
        maxUsers,
        bgFile,
        isLocked: password.trim() !== "",  // password가 있으면 잠금(true)
      });
      onClose();
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-2xl w-full max-w-md p-8 relative">
        ...
        <h2 className="text-2xl text-black font-semibold mb-6">스터디 룸 생성</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center border-b border-gray-300 pb-1">
              ...
              <input
                ...
                className="flex-1 outline-none placeholder-gray-400 text-black"
                required
              />
            </div>
          </div>
          ...
          {/* 방 소개 */}
          <div>
            <label className="block text-sm text-gray-600 mb-1">방 소개</label>
            <div className="flex items-center border-b border-gray-300 pb-1">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <span className="text-sm text-gray-600 mr-2">인원 수 설정</span>
              <select
                value={maxUsers}
                onChange={(e) => setMaxUsers(+e.target.value)}
                className="border border-gray-300 text-gray-600 rounded px-2 py-1 outline-none"
              >
                {[4, 8, 12, 16, 20].map((n) => (
