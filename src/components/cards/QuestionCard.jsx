...
export default function QuestionCard({
  ...
  return (
    <div className="relative group ml-5 mr-15">
      <Link
        to={`/questions/${id}`}
        state={{          
          id,
        ...
        className={`block -mx-0 lg:-mx-4 lg:sm:-mx-6 lg:md:-mx-8 px-0 sm:px-6 md:px-8 border-b py-4 sm:py-5 md:py-6 transition-colors duration-200 ${isDark ? 'border-gray-700 hover:bg-[#2D2F40]' : 'border-gray-300 hover:bg-gray-50'}`}
      >
        {/* 왼쪽: 태그 + 제목/요약 */}
